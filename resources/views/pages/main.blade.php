                    ...
                    @foreach ($artCourses as $course)
                        <div class="flex flex-col justify-between sm:rounded border bg-white shadow-lg sm:pb-3">
                            ...
                            <div class="self-end w-full sm:py-1">
                                <button
                                    class="text-xl py-3 text-white sm:text-gray-800 bg-red-500 sm:bg-white sm:w-auto w-full sm:mx-auto sm:rounded sm:border sm:border-red-500 sm:px-8 sm:py-1 hover:bg-red-500 hover:text-white">Подробнее</button>
                            </div>
                        </div>
                    @endforeach
                </div>
