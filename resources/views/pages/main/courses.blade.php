     ...
     <div class="container mx-auto w-full sm:w-10/12">
         ...
         <div class="grid gap-6 sm:grid-cols-3">
             @foreach ($artCourses as $course)
                 <div class="flex flex-col justify-between border bg-white shadow-lg rounded pb-3">
                     <div>
                     ...
                     <div class="py-1 w-full">
                         <button
                             class="mx-auto w-3/4 sm:w-auto rounded border border-red-500 bg-white px-8 py-1 text-red-500 hover:bg-red-500 hover:text-white my-5">Подробнее</button>
                     </div>
                 </div>
             @endforeach
         </div>
